...
let MafiaFunctions = {
	...
	foolWin: function () {
		this.game.end('<img width="75" height="75" src="/fx/mafia-fool.png" />', "The fool has been lynched and is victorious!");
	},
};
...
exports.MafiaClasses = {
	...
	villager: {
		name: "Villager",
		side: 'town',
		image: '<img width="75" height="75" src="/fx/mafia-villager.png" />',
	...
	mafia: {
		name: "Mafia",
		side: 'mafia',
		image: '<img width="75" height="75" src="/fx/mafia-mafia.png" />',
	...
	hooker: {
		name: "Hooker",
		side: 'town',
		image: '<img width="75" height="75" src="/fx/mafia-hooker.png" />',
	...
	doctor: {
		name: "Doctor",
		side: 'town',
		image: '<img width="75" height="75" src="/fx/mafia-doctor.png" />',
	...
	cop: {
		name: "Cop",
		side: 'town',
		image: '<img width="75" height="75" src="/fx/mafia-cop.png" />',
	...
	werewolf: {
		name: "Werewolf",
		side: 'solo',
		image: '<img width="75" height="75" src="/fx/mafia-werewolf.png" />',
	...
	fool: {
		name: "Fool",
		side: 'town',
		image: '<img width="75" height="75" src="/fx/mafia-fool.png" />',
	...
	godfather: {
		name: "Godfather",
		side: 'mafia',
		image: '<img width="75" height="75" src="/fx/mafia-godfather.png" />',
	...
	mayor: {
		name: "Mayor",
		side: 'town',
		image: '<img width="75" height="75" src="/fx/mafia-mayor.png" />',
	...
	goon: {
		name: "Goon",
		side: 'solo',
		image: '<img width="75" height="75" src="/fx/mafia-goon.png" />',
